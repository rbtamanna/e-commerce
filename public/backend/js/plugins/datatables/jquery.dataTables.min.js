...
! function(n) {
    ...
    function at(t, e, n, a) {
        ...
        if (null === c.nTr) {
            for (r = n || v.createElement("tr"), c.nTr = r, c.anCells = d, r._DT_RowIndex = e, rt(t, c), l = 0, s = t.aoColumns.length; l < s; l++) i = t.aoColumns[l], (o = (u = !n) ? v.createElement(i.sCellType) : a[l])._DT_CellIndex = {
                row: e,
                column: l
            }, d.push(o), !u && (!i.mRender && i.mData === l || j.isPlainObject(i.mData) && i.mData._ === l + ".display") || (o.innerHTML = J(t, e, l, "display")), i.sClass && (o.className += " " + i.sClass), i.bVisible && !n ? r.appendChild(o) : !i.bVisible && n && o.parentNode.removeChild(o), i.fnCreatedCell && i.fnCreatedCell.call(t.oInstance, o, J(t, e, l), f, e, l);
    ...
    }), w.version = "1.10.23", w.settings = [], w.models = {}, w.models.oSearch = {
        bCaseInsensitive: !0,
        sSearch: "",
        bRegex: !1,
        bSmart: !0
