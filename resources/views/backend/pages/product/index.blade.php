    ...
    <div class="mt-3 mt-sm-0 ml-sm-3">
        <a href="{{ url('product/create') }}">
            <button type="button" class="btn btn-dark mr-1 mb-3">
                <i class="fa fa-fw fa-key mr-1"></i> Add Product
            </button>
        </a>
    </div>
    <div class="mt-3 mt-sm-0 ml-sm-3">
        <a href="{{ url('product/import') }}">
            <button type="button" class="btn btn-dark mr-1 mb-3">
                <i class="fa fa-fw fa-key mr-1"></i> Import Product Data
            </button>
        </a>
    </div>
    <div class="mt-3 mt-sm-0 ml-sm-3">
        <a href="{{ url('product/export') }}">
            <button type="button" class="btn btn-dark mr-1 mb-3">
                <i class="fa fa-fw fa-key mr-1"></i> Export Product Data
            </button>
        </a>
    </div>
@endsection
    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            <div class="block-header">
                <h3 class="block-title">Manage Product</h3>
            </div>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function ($) {
            ...
            var dtable = $('#table').DataTable({
                responsive: true,
                ajax: '{{ url('product/get_product_data') }}',
                paging: true,
