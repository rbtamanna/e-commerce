...
<head>
    ...
    <meta name="description" content="E-commerce System">
                ...
                <div class="hero-static col-lg-4 d-none d-lg-flex flex-column justify-content-center">
                    <div class="p-4 p-xl-5 flex-grow-1 d-flex align-items-center">
                        <div class="w-100">
                            <a class="link-fx font-w600 font-size-h2 text-white" href="index.html">
                                E-<span class="font-w400">commerce</span>
                            </a>
                    ...
                    <div class="p-4 p-xl-5 d-xl-flex justify-content-between align-items-center font-size-sm">
                        <p class="font-w500 text-white-50 mb-0">
                            <strong>E-commerce</strong> &copy; <span data-toggle="year-copy"></span>
                        </p>
                    ...
                    <div class="p-4 w-100 flex-grow-1 d-flex align-items-center">
                        <div class="w-100">
                            ...
                            <div class="text-center mb-5">
                                <p class="mb-3">
{{--                                    <img src="" alt="Logo" style="height: 120px; margin-left: 28%">--}}
                                </p>
